...
/obj/effect/proc_holder/vampire/hypno/fire(mob/living/carbon/human/H)
	...
	H << "<span class='vampirewarning'>[src] is now active. (Use your middle mouse button on anyone \
		to use.)"
	H.visible_message("<span class='warning'>[H] starts twirling their finger in a circle.</span>",\
					"<span class='warning'>[H] starts twirling their finger in a circle.</span>")

	sleep(40) // four second delay.
	return 1
