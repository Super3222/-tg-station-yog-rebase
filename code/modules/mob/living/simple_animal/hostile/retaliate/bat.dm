...
/mob/living/simple_animal/hostile/retaliate/bat/vampire
	desc = "A rare breed of bat which roosts in spaceships. This one seems pretty vampiric."
	maxHealth = 200
	var/mob/living/carbon/human/vamp = null
	var/obj/effect/proc_holder/vampire/battrans/S = null

/mob/living/simple_animal/hostile/retaliate/bat/vampire/verb/humanform()
